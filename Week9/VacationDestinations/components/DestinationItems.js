...
//create a function for destination item with props
  ...
  return (
    ...
    >
      <Pressable
        ...
        onPress={viewImageHandler}//This will map the attibute for each destination item
      >
...
//stylesheet that will be utilized for the destination items
